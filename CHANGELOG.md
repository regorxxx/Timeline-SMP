...
- UI: new 'Edit all...' menu entry for customizable menu entries like axis presets, etc. which allows to easily edit entries on batch, instead of manually navigating the menus. This serves as a workaround of menu being closed everytime a menu entry is clicked on. See [Issue 7]/https://github.com/regorxxx/Infinity-Tools-SMP/issues/7).
